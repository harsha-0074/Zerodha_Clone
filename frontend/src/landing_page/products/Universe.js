  ...
  return (
    <div className="container">
      <div className="row text-center p-3">
        ...
        <div className="col-4 p-3 mt-5">
          <img src="media/images/sensibull-logo.svg" style={{width:"90%"}}></img>
          <p className="text-small text-muted mt-4">
        ...
        <div className="col-4 p-3 mt-5 mb-1 ">
          <img src="media/images/streak-logo.png" style={{width:"60%"}}></img>
          <p className="text-small text-muted mt-4">
        ...
        <div className="col-4 p-3 mt-5">
          <img src="media/images/smallcase-logo.png" style={{width:"60%"}}></img>
          <p className="text-small text-muted mt-4">
        ...
        <div className="col-4 p-3 mt-5 ">
          <img src="media/images/ditto-logo.png" style={{width:"60%"}}></img>
          <p className="text-small text-muted mt-4">
